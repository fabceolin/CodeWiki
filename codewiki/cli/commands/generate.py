...
def generate_command(
    ...
    try:
        ...
        if update and output_dir.exists():
            changed_files = detect_changed_files(repo_path, output_dir, cli_logger=logger, verbose=verbose)
            ...
            if changed_files is not None:
                ...
                invalidate_affected_modules(output_dir, changed_files, cli_logger=logger, verbose=verbose)
